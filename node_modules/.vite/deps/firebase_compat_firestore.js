...
var Blob = class {
  ...
  static fromBase64String(base64) {
    ...
    return new Blob(Dh.fromBase64String(base64));
  }
  static fromUint8Array(array) {
    assertUint8ArrayAvailable();
    return new Blob(Dh.fromUint8Array(array));
  }
  toBase64() {
    assertBase64Available();
...
var IndexedDbPersistenceProvider = class {
  enableIndexedDbPersistence(firestore, forceOwnership) {
    return gh(firestore._delegate, { forceOwnership });
  }
  enableMultiTabIndexedDbPersistence(firestore) {
    return yh(firestore._delegate);
  }
  clearIndexedDbPersistence(firestore) {
    return Ih(firestore._delegate);
  }
};
var Firestore = class {
  ...
  useEmulator(host, port, options = {}) {
    Xa2(this._delegate, host, port, options);
  }
  enableNetwork() {
    return Eh(this._delegate);
  }
  disableNetwork() {
    return Ah(this._delegate);
  }
  enablePersistence(settings) {
    ...
    if (settings) {
      ...
      Qa2("synchronizeTabs", synchronizeTabs, "experimentalForceOwningTab", experimentalForceOwningTab);
    }
  ...
  waitForPendingWrites() {
    return Th(this._delegate);
  }
  onSnapshotsInSync(arg) {
    return af(this._delegate, arg);
  }
  get app() {
    if (!this._appCompat) {
  ...
  collection(pathString) {
    try {
      return new CollectionReference(this, sh(this._delegate, pathString));
    } catch (e) {
  ...
  doc(pathString) {
    try {
      return new DocumentReference(this, rh(this._delegate, pathString));
    } catch (e) {
  ...
  collectionGroup(collectionId) {
    try {
      return new Query(this, ih(this._delegate, collectionId));
    } catch (e) {
      throw replaceFunctionName(e, "collectionGroup()", "Firestore.collectionGroup()");
    }
  }
  runTransaction(updateFunction) {
    return bf(this._delegate, (transaction) => updateFunction(new Transaction(this, transaction)));
  }
  batch() {
    _h(this._delegate);
    return new WriteBatch(new Af(this._delegate, (mutations) => hf(this._delegate, mutations)));
  }
  loadBundle(bundleData) {
    return vh(this._delegate, bundleData);
  }
  namedQuery(name2) {
    return bh(this._delegate, name2).then((expQuery) => {
      if (!expQuery) {
        return null;
      }
      return new Query(
...
var UserDataWriter = class extends $l {
  constructor(firestore) {
    super();
    this.firestore = firestore;
  }
  convertBytes(bytes) {
    return new Blob(new Dh(bytes));
  }
...
var Transaction = class {
  ...
  get(documentRef) {
    ...
    return this._delegate.get(ref).then((result) => new DocumentSnapshot(this._firestore, new Ql(this._firestore._delegate, this._userDataWriter, result._key, result._document, result.metadata, ref.converter)));
  }
...
var DocumentReference = class {
  ...
  static forPath(path, firestore, converter) {
    ...
    return new DocumentReference(firestore, new th(firestore._delegate, converter, new ct(path)));
  }
  static forKey(key, firestore, converter) {
    return new DocumentReference(firestore, new th(firestore._delegate, converter, key));
  }
  get id() {
  ...
  collection(pathString) {
    try {
      return new CollectionReference(this.firestore, sh(this._delegate, pathString));
    } catch (e) {
  ...
  isEqual(other) {
    ...
    return oh(this._delegate, other);
  }
  set(value, options) {
    options = validateSetOptions("DocumentReference.set", options);
    try {
      if (options) {
        return sf(this._delegate, value, options);
      } else {
        return sf(this._delegate, value);
      }
    } catch (e) {
  ...
  update(fieldOrUpdateData, value, ...moreFieldsAndValues) {
    try {
      if (arguments.length === 1) {
        return rf(this._delegate, fieldOrUpdateData);
      } else {
        return rf(this._delegate, fieldOrUpdateData, value, ...moreFieldsAndValues);
      }
    } catch (e) {
  ...
  onSnapshot(...args) {
    ...
    const observer = wrapObserver(args, (result) => new DocumentSnapshot(this.firestore, new Ql(this.firestore._delegate, this._userDataWriter, result._key, result._document, result.metadata, this._delegate.converter)));
    return cf(this._delegate, options, observer);
  }
  get(options) {
    let snap;
    if ((options === null || options === void 0 ? void 0 : options.source) === "cache") {
      snap = Zl(this._delegate);
    } else if ((options === null || options === void 0 ? void 0 : options.source) === "server") {
      snap = Xl(this._delegate);
    } else {
      snap = Jl(this._delegate);
    }
    return snap.then((result) => new DocumentSnapshot(this.firestore, new Ql(this.firestore._delegate, this._userDataWriter, result._key, result._document, result.metadata, this._delegate.converter)));
  }
...
var DocumentSnapshot = class {
  ...
  isEqual(other) {
    return Hl(this._delegate, other._delegate);
  }
};
var QueryDocumentSnapshot = class extends DocumentSnapshot {
  data(options) {
    const data = this._delegate.data(options);
    M2(data !== void 0, "Document in a QueryDocumentSnapshot should exist");
    return data;
  }
};
var Query = class {
  ...
  where(fieldPath, opStr, value) {
    try {
      return new Query(this.firestore, dl(this._delegate, _l(fieldPath, opStr, value)));
    } catch (e) {
  ...
  orderBy(fieldPath, directionStr) {
    try {
      return new Query(this.firestore, dl(this._delegate, Il(fieldPath, directionStr)));
    } catch (e) {
      throw replaceFunctionName(e, /(orderBy|where)\(\)/, "Query.$1()");
    }
  }
  limit(n) {
    try {
      return new Query(this.firestore, dl(this._delegate, El(n)));
    } catch (e) {
  ...
  limitToLast(n) {
    try {
      return new Query(this.firestore, dl(this._delegate, Al(n)));
    } catch (e) {
  ...
  startAt(...args) {
    try {
      return new Query(this.firestore, dl(this._delegate, vl(...args)));
    } catch (e) {
  ...
  startAfter(...args) {
    try {
      return new Query(this.firestore, dl(this._delegate, bl(...args)));
    } catch (e) {
  ...
  endAt(...args) {
    try {
      return new Query(this.firestore, dl(this._delegate, Sl(...args)));
    } catch (e) {
      throw replaceFunctionName(e, "endAt()", "Query.endAt()");
    }
  }
  isEqual(other) {
    return uh(this._delegate, other._delegate);
  }
  get(options) {
    let query;
    if ((options === null || options === void 0 ? void 0 : options.source) === "cache") {
      query = ef(this._delegate);
    } else if ((options === null || options === void 0 ? void 0 : options.source) === "server") {
      query = nf(this._delegate);
    } else {
      query = tf(this._delegate);
    }
    return query.then((result) => new QuerySnapshot(this.firestore, new jl(this.firestore._delegate, this._userDataWriter, this._delegate, result._snapshot)));
  }
  onSnapshot(...args) {
    const options = extractSnapshotOptions(args);
    const observer = wrapObserver(args, (snap) => new QuerySnapshot(this.firestore, new jl(this.firestore._delegate, this._userDataWriter, this._delegate, snap._snapshot)));
    return cf(this._delegate, options, observer);
  }
  withConverter(converter) {
...
var CollectionReference = class extends Query {
  ...
  doc(documentPath) {
    try {
      if (documentPath === void 0) {
        return new DocumentReference(this.firestore, rh(this._delegate));
      } else {
        return new DocumentReference(this.firestore, rh(this._delegate, documentPath));
      }
    } catch (e) {
  ...
  add(data) {
    return uf(this._delegate, data).then((docRef) => new DocumentReference(this.firestore, docRef));
  }
  isEqual(other) {
    return oh(this._delegate, other._delegate);
  }
  withConverter(converter) {
...
var FieldPath = class {
  ...
  constructor(...fieldNames) {
    this._delegate = new Ch(...fieldNames);
  }
  static documentId() {
...
var FieldValue = class {
  ...
  static arrayUnion(...elements) {
    const delegate = Sf(...elements);
    delegate._methodName = "FieldValue.arrayUnion";
    return new FieldValue(delegate);
  }
  static arrayRemove(...elements) {
    const delegate = Df(...elements);
